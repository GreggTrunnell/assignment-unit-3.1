...
let favoriteFoods=['pizza', 'sausages', 'Jucy Lucys'];
console.log( 'Some of my favourite foods are: ', favoriteFoods);
...
console.log('items in animalArray',animalArray);
